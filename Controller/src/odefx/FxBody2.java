...
public class FxBody2 extends DxBody {
    ...
    private FxBody2(DxWorld world){
        super(world);
    }

    public FxBody2 newInstance(DWorld world){
        FxBody2 fxBody2 = new FxBody2((DxWorld)world);
        return fxBody2;
    }
     ...
     * @return
     */
    public static FxBody2 newInstance(DWorld world, DSpace space){
        FxBody2 fxBody2 = new FxBody2((DxWorld)world);
