...
//    GroupWithDGeoms lift;
    ...
    Group botGroup;
    GroupWithDGeoms shooter;
    Rotate shooterElevationRotate = new Rotate(20, 0, 18.5, 0, new Point3D(1, 0, 0));
    List<DBody> ringList = new ArrayList<>();
    ...
    public void init(){
        ...
        shooterMotor = (DcMotorImpl)hardwareMap.dcMotor.get("shooter_motor");
    ...
    protected void createHardwareMap(){
        ...
        hardwareMap.put("shooter_motor", new DcMotorImpl(MotorType.Neverest40, false, true));
...
//        backRightRail.getTransforms().addAll(new Translate(shortRailXOffset, -railYOffset, halfPltHt+pltZOffset+0.5*tetrixWidth));
        ...
        backRail.getTransforms().addAll(new Translate(0, -railYOffset, halfPltHt+pltZOffset+0.5*tetrixWidth));

        botGroup.getChildren().addAll(plates);
        botGroup.getChildren().addAll(frontLeftRail, frontRightRail, frontRail, backRail);
...
//        fxBody.addGeom(rightBackRailBox, shortRailXOffset, -railYOffset, pltZOffset+halfPltHt+tetrixWidth/2.0);
        fxBody.addGeom(backRailBox, 0, -railYOffset, pltZOffset+halfPltHt+0.5*tetrixWidth);
        ...
        for (int i=0; i<4; i++){
            ...
            intakeWheelCyl.getTransforms().addAll(new Translate((-1.5+i)*pltXOffset1/2, halfPltLen2, -halfPltHt+pltZOffset+1),
        ...
        fxBody.addGeom(intakeGeom, 0, halfPltLen2, -halfPltHt+pltZOffset+1, R);
        ...
        shooterWheel.getTransforms().addAll(new Translate(-12.5, 13.75, 1.5), new Rotate(90, Rotate.X_AXIS));
        ...
        shooter.getChildren().addAll(shooterBed, leftShooterRail, rightShooterRail, backShooterRail, shooterWheel);
...
//        lift.updateGeomOffsets();
    ...
    public void handleContacts(int numContacts, DGeom o1, DGeom o2, DContactBuffer contacts, DJointGroup contactGroup){
        ...
        boolean o1Intake = (o1CBits & CBits.BOT_RING_INTAKE) != 0,
        ...
        if (o1Intake && o2Ring || o2Intake && o1Ring) {
            //TODO: Code to handle ring intake, and return without creating contact joint
        ...
        for (int i = 0; i < numContacts; i++) {
            ...
            if (o1Ring && o2Shooter || o2Ring && o1Shooter) {
