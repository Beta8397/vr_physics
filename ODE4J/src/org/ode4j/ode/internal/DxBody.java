...
/*
 *    THIS FILE HAS BEEN MODIFIED BY TEAM BETA FOR USE IN THE VR_PHYSICS PROJECT
 */
...
public class DxBody extends DObject implements DBody, Cloneable {
	...
	//Modified by Team Beta: made dxBodyMaxAngularSpeed public instead of default access.
	public static final int dxBodyMaxAngularSpeed			=128;  	// use maximum angular speed

	//Modified by Team Beta: made dxBodyGyroscopic public instead of private access.
	public static final int dxBodyGyroscopic 				=256;	// use gyroscopic term
	...
	//Modified by Team Beta:  Made flags protected instead of default access.
	protected int flags;			// some dxBodyFlagXXX flags
	//  public dGeom geom;			// first collision geom associated with body
	public DxGeom geom;			// first collision geom associated with body

	//Modified by Team Beta:  made mass and invI protected instead of default access.
	protected DxMass mass;			// mass parameters about POR
	protected DMatrix3 invI;		// inverse of mass.I
	...
	//Modified by Team Beta: made facc, tacc, and finte_rot_axis protected instead of default access.
	protected DVector3 facc,tacc;		// force and torque accumulators
	protected DVector3 finite_rot_axis;	// finite rotation axis, unit length or 0=none

	// auto-disable information
	//Modified by Team Beta: made adis, adis_timeleft and adis_stepsleft protected instead of default access.
	protected dxAutoDisable adis;		// auto-disable parameters
	protected double adis_timeleft;		// time left to be idle
	protected int adis_stepsleft;		// steps left to be idle
	...
	//Modified by Team Beta:  made average_lvel_buffer and average_avel_buffer protected instead of default access
	protected DVector3[] average_lvel_buffer;      // buffer for the linear average velocity calculation
	protected DVector3[] average_avel_buffer;      // buffer for the angular average velocity calculation

	//unsigned
	//Modified by Team Beta: made average_counter and average_ready protected instead of default access.
	protected int average_counter;      // counter/index to fill the average-buffers
	protected int average_ready;            // indicates ( with = 1 ), if the Body's buffers are ready for average-calculations

	//Modified by Team Beta: made moved_callback protected instead of default access.
	protected BodyMoveCallBack moved_callback; // let the user know the body moved
	private dxDampingParameters dampingp; // damping parameters, depends on flags

	//Modified by Team Beta: made max_angular_speed public instead of default access.
	public double max_angular_speed;      // limit the angular velocity to this magnitude
	...
	//Modified by Team Beta: made dBodySetAutoDisableAverageSamplesCount protected instead of default access.
	protected void dBodySetAutoDisableAverageSamplesCount (int average_samples_count)
	{
	...
	//Modified by Team Beta: made dBodySetAutoDisableDefaults protected instead of default access.
	protected void dBodySetAutoDisableDefaults ()
	{
		DxWorld w = world;
		adis = w.adis.clone();
	...
	//Modified by Team Beta: made dBodySetDampingDefaults public instead of default access.
	public void dBodySetDampingDefaults()
	{
		DxWorld w = world;
