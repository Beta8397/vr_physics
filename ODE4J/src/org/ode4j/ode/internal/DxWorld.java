...
public class DxWorld extends DBase implements DWorld {
	...
	//Modified by Team Beta: made body_flags public instead of default access.
...
//	* @see DWorld#setStepMemoryManager(DWorldStepMemoryFunctionsInfo)
	...
	*/
    ...
    public static class DWorldStepMemoryFunctionsInfo
	{
	    ...
	    public static final alloc_block_fn_t alloc_block = new alloc_block_fn_t() {
			@Override
	    ...
	    public static final shrink_block_fn_t shrink_block = new shrink_block_fn_t() {
			@Override
	    ...
	    public static final free_block_fn_t free_block = new free_block_fn_t() {
			@Override
